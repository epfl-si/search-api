...
print-env: check-env
	...
	@echo ""
	@echo "SEARCH_API_SESSION_SECRET=${SEARCH_API_SESSION_SECRET}"
	@echo "SEARCH_API_SEARCH_URL=${SEARCH_API_SEARCH_URL}"
	@echo "SEARCH_API_X_EPFL_INTERNAL=${SEARCH_API_X_EPFL_INTERNAL}"
	@echo ""
	...
	@echo ""
	@echo "SEARCH_API_ELASTIC_SEARCH_URL=${SEARCH_API_ELASTIC_SEARCH_URL}"
	@echo "SEARCH_API_ELASTIC_RO_USERNAME=${SEARCH_API_ELASTIC_RO_USERNAME}"
	@echo "SEARCH_API_ELASTIC_RO_PASSWORD=${SEARCH_API_ELASTIC_RO_PASSWORD}"
	@echo ""
	@echo "SEARCH_API_OIDC_TENANT_ID=${SEARCH_API_OIDC_TENANT_ID}"
	@echo "SEARCH_API_OIDC_RP_CLIENT_ID=${SEARCH_API_OIDC_RP_CLIENT_ID}"
	@echo "SEARCH_API_OIDC_RP_CLIENT_SECRET=${SEARCH_API_OIDC_RP_CLIENT_SECRET}"
	@echo "SEARCH_API_OIDC_REDIRECT_URI=${SEARCH_API_OIDC_REDIRECT_URI}"
